          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                ...
                <button className="px-8 py-3 bg-gradient-to-r from-pulse-500 to-pulse-600 hover:from-pulse-600 hover:to-pulse-700 text-white font-semibold rounded-full transition-all duration-300 shadow-lg shadow-pulse-500/25 hover:shadow-xl hover:shadow-pulse-500/30 transform hover:scale-[1.05] active:scale-[0.95] group relative overflow-hidden">
